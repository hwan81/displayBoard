...
<body class="bg-gray-100">
    ...
    <div class="flex flex-col md:flex-row h-full">
        ...
        <aside class="w-full md:w-96 bg-white shadow-lg p-4 md:p-6 flex flex-col flex-shrink-0">
            ...
            <div class="mt-4 pt-4 border-t">
                <h3 class="text-lg font-semibold mb-3">나이스 API 설정</h3>
                <form id="apiSettingsForm" class="space-y-3">
                    <div>
                        <label for="apiAreaCode" class="block text-sm font-medium text-gray-600">지역코드</label>
                        <input type="text" id="apiAreaCode" name="api_area_code" class="w-full p-2 mt-1 border rounded-md text-sm" placeholder="예: J10">
                    </div>
                    <div>
                        <label for="apiSchoolCode" class="block text-sm font-medium text-gray-600">행정표준코드</label>
                        <input type="text" id="apiSchoolCode" name="api_school_code" class="w-full p-2 mt-1 border rounded-md text-sm" placeholder="예: 7530229">
                    </div>
        ...
        <main class="flex-1 p-3 md:p-4 overflow-y-auto">
            <header class="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button id="show-slides-modal-btn" class="flex items-center justify-center flex-grow md:flex-grow-0 bg-blue-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-700 transition-colors text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" />
                        </svg>
                        목록 (<span id="slide-count">0</span>)
                    </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const showSlidesModalBtn = document.getElementById('show-slides-modal-btn');
            ...
            showSlidesModalBtn.addEventListener('click', () => {
                slidesModal.classList.remove('hidden');
                fetchSlides(selectedDate, modalSlideList); // Fetch slides for the selected date for the modal
            });
            ...
            modalSlideList.addEventListener('click', (e) => {
